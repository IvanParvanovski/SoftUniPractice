...
namespace Eventures.Services
{
    public class EventService : IEventService
    {
        ...
        {
            List<EventServiceModel> events = this.mapper
                .Map<List<EventServiceModel>>(
                    this.context.Events
        ...
        public async Task<EventServiceModel> GetEventById(int id)
        {
            ...
            return ev == null
                ? null
                : this.mapper.Map<EventServiceModel>(ev);
        }

        public async Task SaveEvent(string name,
            string place,
            DateTime start,
            DateTime end,
            int totalTickets,
